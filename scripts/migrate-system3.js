// Migration script for System 3 historical data
...
const CSV_FILE_PATH = path.join(
  __dirname,
  "../system-historical-data/FST System 3.xlsx - FST System 3.csv"
);
...
async function migrateSystem3() {
  try {
    console.log("🔄 Starting System 3 migration...");

    // Connect to database
    await connectDB();
    console.log("✅ Connected to database");

    // Create or find System 3
    let system3 = await System.findOne({ slug: "system-3" });
    if (!system3) {
      system3 = await System.create({
        name: "System 3",
        slug: "system-3",
        description: "FST System 3 - Win markets only",
        isActive: true,
      ...
      console.log("✅ Created System 3");
    } else {
      console.log("✅ Found existing System 3");
    }
