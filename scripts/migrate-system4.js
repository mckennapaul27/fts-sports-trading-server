// Migration script for System 4 historical data
...
const CSV_FILE_PATH = path.join(
  __dirname,
  "../system-historical-data/FST System 4.xlsx - FST System 4.csv"
);
...
async function migrateSystem4() {
  try {
    console.log("🔄 Starting System 4 migration...");

    // Connect to database
    await connectDB();
    console.log("✅ Connected to database");

    // Create or find System 4
    let system4 = await System.findOne({ slug: "system-4" });
    if (!system4) {
      system4 = await System.create({
        name: "System 4",
        slug: "system-4",
        description: "FST System 4 - Win markets only",
        isActive: true,
      ...
      console.log("✅ Created System 4");
    } else {
      console.log("✅ Found existing System 4");
    }

    // Delete existing System 4 selections to avoid duplicates
    const deletedCount = await SystemSelection.deleteMany({
      systemId: system4._id,
    });
