// Migration script for System 2 historical data
...
const CSV_FILE_PATH = path.join(
  __dirname,
  "../system-historical-data/FST System 2.xlsx - FST System 2.csv"
);
...
async function migrateSystem2() {
  try {
    console.log("🔄 Starting System 2 migration...");

    // Connect to database
    await connectDB();
    console.log("✅ Connected to database");

    // Create or find System 2
    let system2 = await System.findOne({ slug: "system-2" });
    if (!system2) {
      system2 = await System.create({
        name: "System 2",
        slug: "system-2",
        description: "FST System 2 - Win markets only",
        isActive: true,
      ...
      console.log("✅ Created System 2");
    } else {
      console.log("✅ Found existing System 2");
    }
